...
> **v6.2.1 기준** — 인트라넷 백엔드, 6개 신체 부위 평가 모듈, 영상 분석 파이프라인, EMR 연동 및 운영·배포 구성을 반영함.
