    ...
    <div className="dashboard-section">
      ...
      <div className="dashboard-chart-area">
        ...
        <div className="dashboard-chart-body">
          {Array.from({ length: gridSteps + 1 }, (_, i) => (
            <div className="dashboard-grid-line" key={i} style={{ top: `${(i / gridSteps) * 100}%` }} />
          ))}
            ...
            {data.map(m => (
              <div className="dashboard-bar-wrapper" key={m.key}>
                <div
                  ...
                  style={{ height: `${(m.count / yMax) * 100}%`, background: color }}
                >
...
const Dashboard = ({ patients, onSelectPatient }) => {
  ...
  return (
    <div className="dashboard">
      ...
      {/* 최근 활동 */}
      <div className="dashboard-section dashboard-recent">
        ...
        {stats.recentActivity.length > 0 ? (
            ...
            <tbody>
              {stats.recentActivity.map((item, i) => (
                <tr key={i}>
                  <td>
                    {onSelectPatient ? (
                      <a href="#" onClick={e => { e.preventDefault(); onSelectPatient(item.id); }}
                        title="편집창으로 즉시 이동"
          ...
          <div className="dashboard-empty" style={{ padding: '20px 0' }}>
            최근 활동이 없습니다.
          </div>
        )}
      </div>
