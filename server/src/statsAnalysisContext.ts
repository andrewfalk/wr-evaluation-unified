...
import { StatsAnalysisRecipeSchema, type StatsAnalysisRecipe } from '@wr/contracts';
...
export async function buildAnalysisContext(pool: Pool, req: Request): Promise<BuildAnalysisContextResult> {
  ...
  return {
    ...
    ctx: {
      ...
      differencing, snapshot, dataset, requestSuppressed: reasonCode !== null, reasonCode,
    },
  };
}
