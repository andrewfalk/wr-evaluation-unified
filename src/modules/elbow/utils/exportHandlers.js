...
import { computeElbowCalc, getReasonText, getSideText, getStatusText } from './calculations';
...
function generateEMRData(patientData, calc) {
  ...
  const c = calc || computeElbowCalc(patientData);
...
export const elbowExportHandlers = {
  ...
  pdf: (patientData, calc) => {
    ...
    content.innerHTML = `
      ...
      ${summaryHtml || '<p style="color:#888;">팔꿈치 결과가 없습니다.</p>'}
